...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    const text = "maitland.andrus@gmail.com";
    ...
    >
      ...
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
            ...
            {id === 3 && (
              <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2">
                ...
                <div className="h-48 overflow-hidden">
                  <div className="flex flex-col gap-3 md:gap-3 lg:gap-8 animate-scrollDown">
        ...
        lg:opacity-100 rounded-lg text-center bg-[#10132E]"
                ...
                <div className="h-48 overflow-hidden">
                  <div className="flex flex-col gap-3 md:gap-3 lg:gap-8 animate-scrollUp">
                    <span className="lg:py-4 lg:px-3 py-4 px-3 rounded-lg bg-[#10132E]" />
