...
const Hero = () => {
  ...
  const renderSplitText = (text: string) => {
    return text.split("").map((letter, index) => (
      <span
        key={index}
        className="inline-block transition-all duration-700 ease-out bg-gradient-to-r from-blue-100 to-blue-400 bg-clip-text text-transparent"
        style={{
  ...
  return (
    <div className="pb-20 pt-36">
      ...
      <div
        ref={containerRef}
        className="flex justify-center relative my-20 z-10 px-4 sm:px-6"
      >
            ...
            <div className="mb-6">
              <div className="inline-block relative">
                <div className="text-4xl md:text-6xl lg:text-7xl font-bold">
                  {renderSplitText("Hi I'm Maitland")}
                </div>
                <div className="w-full h-1 bg-gradient-to-r from-blue-400 to-green mt-2 rounded-full animate-fadeIn"></div>
              </div>
            </div>

            <div className="text-lg md:text-xl lg:text-2xl text-gray-300 leading-8 mb-6 animate-fadeIn">
              <VariableProximity
                label="Full-stack MERN developer crafting enterprise software. Proficent in C#, Java, React, Angular and sometimes Perl."
